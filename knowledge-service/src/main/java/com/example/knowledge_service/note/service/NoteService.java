...
public class NoteService {
    ...
    public Note getDetailNote(Long id) {
        ...
        return noteRepository.findById(id)
                .orElseThrow(() -> {
                    return new RuntimeException("해당 노트를 찾을 수 없습니다. noteId : " + id);
                });
    }
    ...
    public void createNewNote(NoteDTO noteDTO, Long userId) {
       ...
       User user = userRepository.findById(userId)
                .orElseThrow(() -> {
                    return new RuntimeException("해당 사용자를 찾을 수 없습니다. userId : " + userId);
                });
	...
	public void updateNote(Long id, NoteDTO noteDTO) {
        ...
        Note note = noteRepository.findById(id)
                .orElseThrow(() -> {
                    return new RuntimeException("해당 노트가 존재하지 않습니다. noteId : " + id);
                });
